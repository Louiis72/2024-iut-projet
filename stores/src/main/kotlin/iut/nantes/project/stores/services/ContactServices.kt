...
class ContactServices(val contactRepository: ContactRepository) {
    ...
    fun findContactById(id: Long): ContactDto {
        ...
        val contact =
            contactRepository.findById(id).orElseThrow { NoSuchElementException("Aucun contact trouvée avec cet Id") }
    ...
    fun updateContactById(id: String, contact: ContactDto): ContactDto {
        ...
        val newContact = contactRepository.findById(idLong)
            .orElseThrow { NoSuchElementException("Aucun contact trouvée avec cet Id") }
